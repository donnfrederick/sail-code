...
RSpec.describe Api::V1::Teachers::SessionsController, type: :request do
  let(:user) { create :teacher }

  describe "POST /api/v1/teachers/signin.json" do
    ...
    context "when is successfully with fcm_token" do
      ...
      before(:each) do
        post "/api/v1/teachers/signin.json", params: signin_params
      end
  ...
  describe "DELETE /api/v1/teachers/signout.json" do
    context "when logout correctly" do
      before(:each) {
        ...
        delete "/api/v1/teachers/signout.json", headers: {
