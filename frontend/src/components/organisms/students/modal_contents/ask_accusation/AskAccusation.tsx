...
import CompleteAccusationModal from 'components/organisms/students/modal_contents/complete_accusation'
...
export default (props: Props) => {
  ...
  return (
    <Container>
      <ModalTextContainer heading={'Please tell us the reason for reporting'} />
      <ReasonList>
        {reasons.map(reason => (
